...
<div class="login-box">
    <div class="login-logo">
        <a href="{{url()->current()}}"><b>Admin &nbsp;</b>{{ __('Reset Password') }}</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Type your email address here</p>
        @if (session('status'))
        ...
        <form action="{{ route('password.update') }}" method="post">
            ...
            <div class="form-group has-feedback">
                ...
                @enderror
                <input type="password" name="password_confirmation" class="form-control @error('email') is-invalid @enderror" placeholder="ReType your password">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
